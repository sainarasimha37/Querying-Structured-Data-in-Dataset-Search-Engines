...
mkdir -p volumes/datasets && sudo chown -R 998 volumes/datasets && sudo chmod -R 777 volumes/datasets
mkdir -p volumes/cache && sudo chown -R 998 volumes/cache && sudo chmod -R 777 volumes/cache
